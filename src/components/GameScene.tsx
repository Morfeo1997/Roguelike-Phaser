...
export class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('player-dash', 'assets/sprites/player/player-dash.png');
    ...
    this.load.image('player-projectile-sprite', 'assets/sprites/player/projectile.png');
    ...
    this.load.audio('player-shoot-sound', 'assets/sounds/effects/player-shoot.wav');
